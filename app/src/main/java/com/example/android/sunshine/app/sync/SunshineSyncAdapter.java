    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "ad05b9e0c2293505a5414cb7ada8a3b8")
                    .build();
    ...
    private static void configurePeriodicSync(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            SyncRequest request = new SyncRequest.Builder().
                    syncPeriodic(SunshineSyncAdapter.SYNC_INTERVAL, SunshineSyncAdapter.SYNC_FLEXTIME).
                    setSyncAdapter(account, authority).
                    setExtras(new Bundle()).build();
            ContentResolver.requestSync(request);
        } else {
            ContentResolver.addPeriodicSync(account,
                    authority, new Bundle(), SunshineSyncAdapter.SYNC_INTERVAL);
        }
    }
